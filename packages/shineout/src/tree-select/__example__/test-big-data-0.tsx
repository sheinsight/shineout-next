...
import bigData from './big-data-0'
  ...
  { title: 'id', render: 'id', width: 200 },
  {
    ...
    render: (d, index) => (
      <TreeSelect
        ...
        onFilter={text => item => item.cname.indexOf(text) > -1}
      />
    ),
    width: 400,
  },
...
const App: React.FC = () => {
  const [formValue, setFormValue] = useState({cname: data.map(() => ({uid: '1b0bc03b-dca7-46e3-8e4c-6ff0dc315b52'}))})
