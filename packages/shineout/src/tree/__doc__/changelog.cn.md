...
2025-12-09
### 🆕 Feature
- `Tree` 新增 `filteredData` 属性，用于需过滤数据但勾选基于全量data的场景 ([#1510](https://github.com/sheinsight/shineout-next/pull/1510))([#1515](https://github.com/sheinsight/shineout-next/pull/1515))
