...
import { CollapseTokens } from './type';
...
const collapseTokens: CollapseTokens = {
  ...
  collapseWrapperPaddingX: 'Padding-16',
  collapseWrapperPaddingY: 'Padding-12',
  collapseHeaderLineHeight: 'Size-11',
  collapseHeaderGap: 'Size-4',
  collapseHeaderFontSize: '14/regular',
  collapseHeaderWeight: '400',
  collapseHeaderIconWidth: 'Size-7',
  collapseHeaderExtraGap: 'Size-5',
  collapseContentLineHeight: 'Size-11',
  collapseContentGap: 'Size-12',
  collapseContentPaddingY: 'Padding-12',
  collapseContentFontSize: '14/regular',
  collapseContentWeight: '400',
  collapseContentPaddingLeft: 'Size-19',
  collapseContentPaddingRight: 'Padding-16',
