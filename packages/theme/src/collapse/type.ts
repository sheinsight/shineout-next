...
export interface CollapseTokens {
   ...
   * @type {string}
   * @token Radius-4
   * @description 折叠面板undefined边框圆角
   */
  collapseWrapperBorderRadius: string;
  /**
   * @type {string}
   * @token Size-12
   * @description 折叠面板undefinedundefined
   */
  collapseWrapperGap: string;
  /**
   * @type {string}
   * @token Padding-16
   * @description 折叠面板undefined内边距（水平方向）
   */
  collapseWrapperPaddingX: string;
  /**
   * @type {string}
   * @token Padding-12
   * @description 折叠面板undefined内边距（垂直方向）
   */
  collapseWrapperPaddingY: string;
  /**
   * @type {string}
   * @token Size-11
   * @description 折叠面板undefined行高度
   */
   ...
   * @type {string}
   * @token Size-7
   * @description 折叠面板undefined图标宽度
   */
  collapseHeaderIconWidth: string;
  /**
   * @type {string}
   * @token Size-5
   * @description 折叠面板undefinedundefinedundefined
   */
   ...
   * @type {string}
   * @token Size-19
   * @description 折叠面板undefined内边距undefined
   */
   ...
   * @description 折叠面板undefined边框颜色
   */
  collapseWrapperBorderColor: string;
  /**
   * @type {string}
   * @token Neutral-border-1
   * @description 折叠面板undefined颜色
   */
  collapseWrapperColor: string;
  /**
   * @type {string}
   * @token Neutral-fill-1
   * @description 折叠面板undefined背景颜色
   */
