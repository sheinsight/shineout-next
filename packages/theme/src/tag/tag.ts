...
const tagTokens: TagTokens = {
  ...
  tagDefaultDisabledBackgroundColor: 'Neutral-fill-3',
  tagDefaultDisabledBorderColor: 'Neutral-fill-3',
  ...
  tagOrangeOutlineFontColor: 'Orange-5',
  tagOrangeOutlineBackgroundColor: 'Neutral-fill-1',
  tagOrangeOutlineBorderColor: 'Orange-5',
