...
export interface BaseToken {
  ...
  warning_8: string;
  warning_9: string;
  'neutral_text_5': string;
  'neutral_text_4': string;
  'neutral_text_3': string;
  'neutral_text_2': string;
  'neutral_text_1': string;
  'neutral_border_2': string;
  'neutral_border_1': string;
  'neutral_fill_5': string;
  'neutral_fill_9': string;
  'neutral_fill_10': string;
  'neutral_fill_6': string;
  'neutral_fill_4': string;
  'neutral_fill_3': string;
  'neutral_fill_2': string;
  'neutral_fill_1': string;
  medium: string;
  padding_1: string;
  padding_2: string;
  padding_3: string;
