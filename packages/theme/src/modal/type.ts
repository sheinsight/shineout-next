...
export interface ModalTokens {
   ...
   * @type {string}
   * @token Size-8
   * @description 对话框头部区域关闭icon的字号
   */
  modalHeaderCloseSize: string;
  /**
   * @type {string}
   * @token Size-2
   * @description 对话框头部区域关闭icon的顶部距离
   */
  modalHeaderCloseTop: string;
  /**
   * @type {string}
   * @token Neutral-text-4
   * @description 对话框头部区域关闭icon的颜色
   */
  modalHeaderCloseColor: string;
  /**
   * @type {string}
   * @token Neutral-fill-2
   * @description 对话框头部区域关闭icon的背景颜色
   */
   ...
   * @description 对话框抽屉模式关闭icon的背景颜色
   */
