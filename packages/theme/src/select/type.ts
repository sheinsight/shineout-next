...
export interface SelectTokens {
   ...
   * @type {string}
   * @token Brand-1
   * @description 选择器结果文本鼠标点击时的背景颜色
   */
  selectResultTextActiveBackgroundColor: string;
  /**
   * @type {string}
   * @token Danger-6
   * @description 选择器错误状态的边框颜色
   */
