...
const cascaderTokenExtraValue = {
  ...
  small: {
    ...
    option: { inner: { padding: { x: 'Spacing-8', y: 'Spacing-2' } }, icon: { size: 'Font-12' } },
    clear: { icon: { size: 'Font-12' } },
  },
  large: {
    font: { size: 'Font-16' },
    padding: { x: 'Spacing-12', y: 'Spacing-3' },
    option: { inner: { padding: { x: 'Spacing-12', y: 'Spacing-8' } }, icon: { size: 'Font-16' } },
  ...
  list: { border: { color: 'Neutral-border-1' }, padding: { y: 'Spacing-3' } },
};
