export interface Tokens {
   ...
   * @categoty color
   * @default '#F4F5F8'
   * @description 禁用/表头/底层背景
   */
  'Neutral-fill-2': string;
  /**
   * @type {string}
   * @categoty color
   * @default '#FFFFFF'
   ...
   * @type {string}
   * @categoty string
   * @default '0 -2px 10px rgba(102,108,124,0.08)'
