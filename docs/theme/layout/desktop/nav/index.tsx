  ...
  return (
    <div className={classes.nav}>
      ...
      <ul className='entry'>
        ...
        <li onClick={handleChangeLocales}>
          <svg
            width='20'
            height='20'
            viewBox='0 0 20 20'
            ...
            {nav.title === 'Component' ? (
              ...
              >
                <path
                  fillRule='evenodd'
                  clipRule='evenodd'
                  d='M9.03125 13C10.1358 13 11.0312 13.8954 11.0312 15V20C11.0312 21.1046 10.1358 22 9.03125 22H4.03125C2.92668 22 2.03125 21.1046 2.03125 20V15C2.03125 13.8954 2.92668 13 4.03125 13H9.03125ZM20.0312 13C21.1358 13 22.0312 13.8954 22.0312 15V20C22.0312 21.1046 21.1358 22 20.0312 22H15.0312C13.9267 22 13.0312 21.1046 13.0312 20V15C13.0312 13.8954 13.9267 13 15.0312 13H20.0312ZM8.53125 15H4.53125C4.28579 15 4.08164 15.1769 4.03931 15.4101L4.03125 15.5V19.5C4.03125 19.7455 4.20813 19.9496 4.44137 19.9919L4.53125 20H8.53125C8.77671 20 8.98086 19.8231 9.02319 19.5899L9.03125 19.5V15.5C9.03125 15.2239 8.80739 15 8.53125 15ZM19.5312 15H15.5312C15.2858 15 15.0816 15.1769 15.0393 15.4101L15.0312 15.5V19.5C15.0312 19.7455 15.2081 19.9496 15.4414 19.9919L15.5312 20H19.5312C19.7767 20 19.9809 19.8231 20.0232 19.5899L20.0312 19.5V15.5C20.0312 15.2239 19.8074 15 19.5312 15ZM9.03125 2C10.1358 2 11.0312 2.89543 11.0312 4V9C11.0312 10.1046 10.1358 11 9.03125 11H4.03125C2.92668 11 2.03125 10.1046 2.03125 9V4C2.03125 2.89543 2.92668 2 4.03125 2H9.03125ZM17.5312 2C20.0165 2 22.0312 4.01472 22.0312 6.5C22.0312 8.98528 20.0165 11 17.5312 11C15.046 11 13.0312 8.98528 13.0312 6.5C13.0312 4.01472 15.046 2 17.5312 2ZM8.53125 4H4.53125C4.28579 4 4.08164 4.17688 4.03931 4.41012L4.03125 4.5V8.5C4.03125 8.74546 4.20813 8.94961 4.44137 8.99194L4.53125 9H8.53125C8.77671 9 8.98086 8.82312 9.02319 8.58988L9.03125 8.5V4.5C9.03125 4.22386 8.80739 4 8.53125 4ZM17.5312 4C16.1505 4 15.0312 5.11929 15.0312 6.5C15.0312 7.88071 16.1505 9 17.5312 9C18.912 9 20.0312 7.88071 20.0312 6.5C20.0312 5.11929 18.912 4 17.5312 4Z'
                  fill='#333E59'
                />
              </svg>
            ) : (
